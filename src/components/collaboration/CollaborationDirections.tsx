...
export default function CollaborationDirections() {
  return (
    <div className="space-y-10 px-4 py-10 md:px-16">
      <div className="">
      ...
      {data.map((item) => (
        <div
          key={item.id}
          className="flex flex-col items-start justify-between gap-6 pt-6 md:flex-row"
        >
